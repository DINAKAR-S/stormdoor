...
Then talk to it like any OpenAI endpoint. `echo-small` is a local, deterministic
...
| Latency p50 | 43.6 ms |
| Latency p95 | 142.3 ms |
| Latency p99 | 689.6 ms |
...
| Observed 503s | 97 (24.2%) |
| Succeeded anyway | 303 |
| Marked retryable | 97 / 97 |
| Ledger rows tagged as a drill | 97 |
